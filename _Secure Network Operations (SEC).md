...
conf t
 ...
 int gi 0/0/0
  no shut
  ip add 10.62.62.1 255.255.255.0
  desc INSIDE
 int gi 0/0/1
  no shut
  ip add 200.0.0.62 255.255.255.0
  desc OUTSIDE
 int loopback 0
  ip add 62.0.0.1 255.255.255.255
  desc VIRTUALIP
  end
~~~
...
conf t
 ...
 ip route 10.62.0.0 255.255.0.0 10.62.62.4 253
 no ip route 10.62.0.0 255.255.0.0 200.0.0.62 254
 end
~~~
